...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `
    <div  class="single-product background_color">
      <div>
...
const showDetails = product => {
  ...
  detailDiv.innerHTML = `
  <div class="single-product product-details background_color">
    <div>
    ...
    <div>               
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-warning mx-5">Add to cart</button>
      <button id="details-btn" class="btn btn-danger" onclick="hideDiv()">Cancel</button>
    </div>
  </div>
`;
